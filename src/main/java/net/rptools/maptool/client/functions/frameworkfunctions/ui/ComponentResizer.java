...
public class ComponentResizer extends MouseAdapter {
  ...
  private Component resizeThis;

  public Component getResizeThis() {
    return resizeThis;
  }

  public void setResizeThis(Component resizeThis) {
    this.resizeThis = resizeThis;
  }
  ...
  /**
   * Specify the maximum size for the component. The component will still be constrained by the size
   * of its parent.
   *
  ...
  public void mousePressed(MouseEvent e) {
    ...
    if (frameDragListener != null) {
      frameDragListener.setEnabled(false);
    }
  ...
  public void mouseReleased(MouseEvent e) {
    resizing = false;
    if (frameDragListener != null) {
      frameDragListener.setEnabled(true);
    }
    ...
    // if (resizeThis != null && resizeThis instanceof JFrame) ((JFrame)resizeThis).pack();
    if (resizeThis != null) {
      resizeThis.invalidate();
    }
  }
  ...
  public void mouseDragged(MouseEvent e) {
    ...
    Component source = e.getComponent();
    // if(resizeThis != null) { source = resizeThis; }
  ...
  public FrameDragListener getFrameDragListener() {
    return frameDragListener;
  }

  public void setFrameDragListener(FrameDragListener frameDragListener) {
    this.frameDragListener = frameDragListener;
  }
}
